  ...
  <div>
    ...
    <el-table :data="videos" stripe style="margin-top:20px">
      ...
      <el-table-column label="操作" width="460">
        <template #default="{ row }">
          <el-button size="small" @click="openEdit(row)">编辑分组</el-button>
    ...
    <el-dialog v-model="editVisible" title="编辑视频分组" width="480px" @closed="resetEditForm">
      ...
      <p class="edit-hint">可将已上传视频归入已有剧集，或输入新剧名创建分组。</p>
      <template #footer>
